...
public class MultipartRequest extends Request<NetworkResponse> {
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        ...
        if (cache.getSession() != null) {
            mHeaders.put(mContext.getString(R.string.header_cookie), cache.getSession());
        }

        mHeaders.put(mContext.getString(R.string.header_authorization), mAuthorization);
        mHeaders.put(mContext.getString(R.string.header_accept), mContext.getString(R.string.application_json));
        return mHeaders;
    }
